 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LCtrl |      |      | LAlt | LGUI |                                       | Left | Down |  Up  | Right| (L1) |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | (L4) | ~L1  |       | ~L3  | ~L5    |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
        KC_DELETE,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,       KC_EQL,
 ...
 * |        |      |      | MsUp |      |      |      |           |      |      |      |Ctl(U)|      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght|      |------|           |------|      |Ctl(L)|Ctl(D)|Ctl(R)|      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      | Prev | Next | Play |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |VolDn |VolUp | Mute |      |      |
 ...
 * `-----------+------+------+------+------+-------------'           `-------------+------+------+------+------+-----'
 *   |LCtrl | Down |  Up  | LAlt | LGUI |                                       | Left |Right |   [  |   ]  |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
KEYMAP(
       ...
       KC_LCTL,        KC_DOWN,        KC_UP,    KC_LALT, KC_LGUI,
                                       KC_TRNS,KC_TRNS,
                                               KC_TRNS,
                               KC_TRNS,KC_TRNS,KC_TRNS,
      // right hand
      ...
      MEH_T(KC_NO),KC_N,   KC_M,   KC_COMM,   KC_DOT,   KC_SLSH,  KC_RSFT,
                           KC_LEFT,KC_RGHT ,KC_LBRC,KC_RBRC,      KC_TRNS,
      KC_TRNS, KC_TRNS,
      KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS
    ),
/* Keymap 4: LH controls
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Redo?  |Undo? |Cut?  |Copy? |Pste? |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |      |Ctl(U)|      |VolUp |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |Ctl(L)|Ctl(D)|Ctl(R)|VolDn |------|           |------|      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      | Prev | Next | Play | Mute |      |           |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
...
KEYMAP(
       KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS,       LCTL(KC_UP),   KC_TRNS,       KC_VOLU, KC_TRNS,
       KC_TRNS, KC_TRNS, LCTL(KC_LEFT), LCTL(KC_DOWN), LCTL(KC_RGHT), KC_VOLD,
       KC_TRNS, KC_TRNS, KC_MPRV,       KC_MNXT,       KC_MPLY,       KC_MUTE,  KC_TRNS, 
       KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,       KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
                                  KC_TRNS, KC_TRNS, KC_TRNS,
...
/*** Utility layers should be defined from here ***/
/* Keymap 8: (UTILITY) Blank
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
...
void matrix_scan_user(void) {
    ...
    switch (layer) {
      ...
      // awan edit: use binary to represent layers
        case 1:
